...
class _QuizQuestState extends State<QuizQuest> {
  List<Map> allQuestions = [
    ...
    },
    {
      ...
      "options": [" Changeable" ," Constant ", "No internal state", "External state"],
      "answerIndex": 0,
    },
    {
      "question": "What is the purpose of pubspec.yaml in Flutter ?",
      "options": ["Define dependencies","Main code ","Configure permissions ","UI layouts"],
      "answerIndex": 0,
    },
    {
  ...
  Scaffold whichScreen() {
    ...
    if (questionScreen == 0) {
      return Scaffold(
        ...
        //   ),
        //   centerTitle: true,
        //   backgroundColor: Color.fromARGB(255, 91, 233, 198),
        // ),
        body: Center(
          child: Container(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    // const Icon(Icons.arrow_circle_right_outlined,size: 40,)
                  ],
                ),
              ],
            ),
      ...
      return Scaffold(
        ...
        body: Container(
          color: Color.fromARGB(112, 129, 255, 228),
          child: Column(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Color.fromARGB(102, 100, 255, 219),
            ...
            // Image.network(
            //   // "https://thumbs.dreamstime.com/z/lit-light-bulb-27281548.jpg?w=768",
            //   // "https://thumbs.dreamstime.com/z/light-bulb-27180651.jpg?ct=jpeg",
            //   // "https://thumbs.dreamstime.com/b/burst-light-bulb-crack-lightbulb-sketch-shards-glass-burst-light-bulb-crack-lightbulb-sketch-shards-glass-concept-258255667.jpg?w=768",
            //   // height: 110,
            // ),
            Container(
